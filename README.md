...
Подробный разбор именно публичных 25 Android- и 15 серверных классов, а также
авторских XML, YAML, Gradle, Maven и SQL-файлов:
[`docs/SMetrix_public_code_detailed_review.md`](docs/SMetrix_public_code_detailed_review.md).
